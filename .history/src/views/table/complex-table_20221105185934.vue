  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.aid" placeholder="资产类型" clearable class="filter-item" style="width: 130px">
        <el-option v-for="item in assetTypeOptions" :key="item.key" :label="item.display_name+'('+item.key+')'" :value="item.key" />
      </el-select>
      <el-select v-model="listQuery.sort" placeholder="地区类型" clearable style="width: 140px" class="filter-item">
