    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="center" label-width="80px" style="width: 400px; margin-left:50px;">
        <el-form-item label="资产类型" prop="aid">
          <el-select v-model="temp.aname" class="filter-item" placeholder="请选择资产类型">
            <el-option v-for="item in assetTypeOptions" :key="item.display_name" :label="item.display_name" :value="item.display_name" />
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="区域类型" prop="rid">
          <el-select v-model="temp.rname" class="filter-item" placeholder="请选择区域类型">
            <el-option v-for="item in regionsOptions" :key="item.label" :label="item.label" :value="item.label" />
          </el-select>
        </el-form-item>
...
<script>
import { fetchList, fetchPv, createAsset, updateAsset } from '@/api/asset'
