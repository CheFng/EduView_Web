<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%;">
      ...
      <el-table-column label="区域类型" width="100px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.rname }}</span>
        </template>
      </el-table-column>
      <el-table-column label="资产类型" width="100px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.aname }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="创建时间" type="timestamp" :formatter="formatJson" width="200px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.gmtcreate }}</span>
        </template>
      </el-table-column>
      <el-table-column label="最后修改时间" type="timestamp" :formatter="formatJson" width="200px" align="center">
        <template slot-scope="{row}">
