<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="center" label-width="80px" style="width: 400px; margin-left:50px;text-align: center">
        <el-form-item label="资产类型" prop="aid" style="display: inline-block">
          <el-select v-model="temp.aid" class="filter-item" placeholder="请选择资产类型">
            <el-option v-for="item in assetTypeOptions" :key="item.key" :label="item.display_name" :value="item.key" />
          </el-select>
        </el-form-item>
        <el-form-item label="年份" prop="year" style="width: 285px;display: inline-block">
          <el-input v-model="temp.year" placeholder="请输入年份" />
        </el-form-item>
        <el-form-item label="区域类型" prop="rid" style="display: inline-block">
          <el-select v-model="temp.rid" class="filter-item" placeholder="请选择区域类型">
            <el-option v-for="item in regionsOptions" :key="item.key" :label="item.label" :value="item.key" />
          </el-select>
        </el-form-item>
        <el-form-item label="数量" prop="aValue" style="width: 285px;display: inline-block">
