<template>
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="75px" style="width: 400px; margin-left:50px;">
        <el-form-item label="资产类型" prop="type">
          <el-select v-model="temp.aid" class="filter-item" placeholder="请选择">
            <el-option v-for="item in assetTypeOptions" :key="item.key" :label="item.display_name" :value="item.key" />
          </el-select>
        </el-form-item>
        <el-form-item label="年份" prop="timestamp">
          <el-date-picker v-model="temp.year" type="datetime" placeholder="选择年份" />
        </el-form-item>
        <el-form-item label="区域类型">
          <el-select v-model="temp.rid" class="filter-item" placeholder="请选择">
            <el-option v-for="item in statusOptions" :key="item" :label="item" :value="item" />
          </el-select>
        </el-form-item>
        <el-form-item label="数量">
          <el-input v-model="temp.aValue" :autosize="{ minRows: 2, maxRows: 4}" type="textarea" placeholder="请选择" />
        </el-form-item>
      </el-form>
