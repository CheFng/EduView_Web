<template>
  <div class="container">
    <div class="box left">
      <dv-decoration-7 style="width:150px;height:30px;">首页可视化</dv-decoration-7>
      <dv-decoration-7 style="width:150px;height:30px;">面积可视化</dv-decoration-7>
      <dv-border-box-8 class="border-box">
        <dv-scroll-board :config="config2" class="charts" style="height:300px" />
      </dv-border-box-8>
