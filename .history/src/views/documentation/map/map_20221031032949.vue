  ...
  <div class="container">
    <div class="box left">
      ...
      <dv-border-box-8 class="border-box">
        ...
        <LineChart v-if="1===number" class="charts" style="height:250px" />
      </dv-border-box-8>
      <!--左列box2-->
      <dv-border-box-1 class="border-box">
        <dv-scroll-ranking-board v-if="0===number" :config="config2" class="charts" style="height:250px" />
        <dv-scroll-ranking-board v-if="===number" :config="config3" class="charts" style="height:250px" />
      </dv-border-box-1>
    </div>
