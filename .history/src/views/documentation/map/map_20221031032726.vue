<template>
  <div class="container">
    <div class="box left">
      ...
      <!--左列box1-->
      <dv-border-box-8 v-if="0===number" class="border-box">
        <dv-scroll-board :config="config2" class="charts" style="height:250px" />
      </dv-border-box-8>
      <dv-border-box-8 v-if="1===number" class="border-box">
        <LineChart class="charts" style="height:250px" />
      </dv-border-box-8>
      <!--左列box2-->
      <dv-border-box-1 v-if="0===number" class="border-box">
        <dv-scroll-ranking-board :config="config2" class="charts" style="height:250px" />
      </dv-border-box-1>
      <dv-border-box-1 v-if="1===number" class="border-box">
