<template>
  <div class="container">
    <div class="box left">
      <dv-decoration-7 class="border-box">
    ...
    <div class="box right">
      ...
      <dv-border-box-1 class="border-box">
        <MixChart v-if="0===number" id="Mix" class="charts" style="height:260px" />
        <LineChart v-if="1===number" id="Line" class="charts" style="height:260px" />
      </dv-border-box-1>
      <dv-border-box-8 class="border-box">
        <dv-scroll-board v-if="0===number" :config="config2" class="charts" style="height:260px" />
        <dv-scroll-ranking-board v-if="1===number" :config="config3" class="charts" style="height:260px" />
      </dv-border-box-8>
    </div>
  </div>
</template>
