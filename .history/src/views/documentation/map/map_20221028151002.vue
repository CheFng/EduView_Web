  ...
  <div class="container">
    ...
    <div class="box center">
      <dv-border-box-11 title="数据可视化平台">
        <dv-flyline-chart-enhanced :config="config4" class="charts" style="width:100%;height:100%;" />
      </dv-border-box-11>
    </div>
    <div class="box right">
      <dv-border-box-1 class="border-box">
        <MixChart class="charts" style="height:300px" />
      </dv-border-box-1>
      <dv-border-box-8 class="border-box">
...
export default {
  name: 'MapShow',
  components: { 'LineChart': LineChart, 'MixChart': MixChart },
  data() {
    return {
      config1,
      config2,
