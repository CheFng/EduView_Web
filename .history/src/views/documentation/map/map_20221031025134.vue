    ...
    <div class="box left">
      <dv-decoration-7 class="btn-box">
        <button class="button" @click="change(1)">
          <dv-decoration-11 id="btn1" class="btn">
            首页可视化
          </dv-decoration-11>
        </button>
        <dv-decoration-11 id="btn2" class="btn">
          面积可视化
        </dv-decoration-11>
      </dv-decoration-7>
      <dv-border-box-8 class="border-box">
        <dv-scroll-board v-show="0===number" :config="config2" class="charts"
          style="height:260px" />
        <dv-scroll-ranking-board v-show="1===number" :config="config3" class="charts"
          style="height:260px" />
      </dv-border-box-8>
